...
# weights_path = open('/Users/nakul/Downloads/yolo.h5')
# model_downloaded = weights_path.read()
# weights_path.close()
weights = h5py.File('yolo.h5','r+')
image1_downloaded = Image.open('san_jose_road.jpg')
image2_downloaded = Image.open('test_image_2.jpg')
video1_downloaded = cv2.VideoCapture('test_video_1.mp4')
...
def draw_boxes(image_, boxes, labels):
    ...
    font = ImageFont.truetype(font="/Library/Fonts/Arial Unicode.ttf",
...
darknet = tf.keras.models.load_model(weights)
...
video_inp = 'test_video_1.mp4'
video_out = 'video_detected1.mp4'
detect_video(video_inp,video_out)
